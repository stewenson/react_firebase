            ...
            <div className={classes.root}>
                <GridList className={classes.gridList}>
                    {data ? data.map((title) => (
                        ...
                        //     <Link to={{pathname: `/tmdbapi/detailMovie/${title.original_name}/${title.id}`, query: "/tmdbapi/detailMovie"}}>
                        //         <img src={`http://image.tmdb.org/t/p/w154/`+ title.poster_path} alt={title.original_name}/>
                        //     </Link>
                        // </GridListTile>
                            <GridListTile key={title.id} className='Title'>
                                <Link to={{pathname: `/tmdbapi/detailMovie/${title.original_title}/${title.id}`, query: "/tmdbapi/detailMovie"}}>
